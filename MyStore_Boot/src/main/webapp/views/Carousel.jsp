		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				...
				<div class="item active imgheight">
					<a href="categories?searchInput=ball"><img src="images/ball.jpg"></a>
				...
				<div class="item imgheight">
					<a href="categories?searchInput=running""><img src="images/shoe.jpg"></a>
					<div class="carousel-caption">
				...
				<div class="item imgheight">
					<a href="categories?searchInput=visor"><img src="images/visor.jpg"></a>
					<div class="carousel-caption">
				...
				<div class="item imgheight">
					<a href="categories?searchInput=vans"><img 
				...
				<div class="item imgheight">
					<a href="categories?searchInput=fishing"><img src="images/fishing_pole.jpg"></a>
					<div class="carousel-caption">
