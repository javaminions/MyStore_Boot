		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				...
				<div class="item active imgheight">
					<a href="/?caroSelection=carousel&amp;prodcode=8"><img src="images/ball.jpg"></a>
				...
				<div class="item imgheight">
					<a href="/?caroSelection=carousel&amp;prodcode=6""><img src="images/shoe.jpg"></a>
					<div class="carousel-caption">
				...
				<div class="item imgheight">
					<a href="/?caroSelection=carousel&amp;prodcode=7"><img src="images/visor.jpg"></a>
					<div class="carousel-caption">
				...
				<div class="item imgheight">
					<a href="/?caroSelection=carousel&amp;prodcode=1"><img 
				...
				<div class="item imgheight">
					<a href="/?caroSelection=carousel&amp;prodcode=3"><img src="images/fishing_pole.jpg"></a>
					<div class="carousel-caption">
